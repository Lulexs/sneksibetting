...
public class Users extends TableImpl<UsersRecord> {
    ...
    /**
     * The column <code>public.users.wins</code>.
     */
    public final TableField<UsersRecord, Integer> WINS = createField(DSL.name("wins"), SQLDataType.INTEGER.defaultValue(DSL.field(DSL.raw("0"), SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>public.users.draws</code>.
     */
    public final TableField<UsersRecord, Integer> DRAWS = createField(DSL.name("draws"), SQLDataType.INTEGER.defaultValue(DSL.field(DSL.raw("0"), SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>public.users.losses</code>.
     */
    public final TableField<UsersRecord, Integer> LOSSES = createField(DSL.name("losses"), SQLDataType.INTEGER.defaultValue(DSL.field(DSL.raw("0"), SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>public.users.bets_won</code>.
     */
    public final TableField<UsersRecord, Integer> BETS_WON = createField(DSL.name("bets_won"), SQLDataType.INTEGER.defaultValue(DSL.field(DSL.raw("0"), SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>public.users.bets_lost</code>.
     */
    public final TableField<UsersRecord, Integer> BETS_LOST = createField(DSL.name("bets_lost"), SQLDataType.INTEGER.defaultValue(DSL.field(DSL.raw("0"), SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>public.users.elo</code>.
     */
    public final TableField<UsersRecord, BigDecimal> ELO = createField(DSL.name("elo"), SQLDataType.NUMERIC(10, 6).defaultValue(DSL.field(DSL.raw("1000"), SQLDataType.NUMERIC)), this, "");

    /**
     * The column <code>public.users.coins</code>.
     */
    public final TableField<UsersRecord, BigDecimal> COINS = createField(DSL.name("coins"), SQLDataType.NUMERIC(10, 6).defaultValue(DSL.field(DSL.raw("100"), SQLDataType.NUMERIC)), this, "");
    ...
    public BetsPath bets() {
        if (_bets == null)
            _bets = new BetsPath(this, null, Keys.BETS__BETS_USER_ID_FKEY.getInverseKey());

        return _bets;
    }

    private transient GamesPath _gameUserFk1;

    /**
     * Get the implicit to-many join path to the <code>public.games</code>
     * table, via the <code>game_user_fk1</code> key
     */
    public GamesPath gameUserFk1() {
        if (_gameUserFk1 == null)
            _gameUserFk1 = new GamesPath(this, null, Keys.GAMES__GAME_USER_FK1.getInverseKey());

        return _gameUserFk1;
    }

    private transient GamesPath _gameUserFk2;

    /**
     * Get the implicit to-many join path to the <code>public.games</code>
     * table, via the <code>game_user_fk2</code> key
     */
    public GamesPath gameUserFk2() {
        if (_gameUserFk2 == null)
            _gameUserFk2 = new GamesPath(this, null, Keys.GAMES__GAME_USER_FK2.getInverseKey());

        return _gameUserFk2;
    }

    private transient GamesPath _gameUserFk3;

    /**
     * Get the implicit to-many join path to the <code>public.games</code>
     * table, via the <code>game_user_fk3</code> key
     */
    public GamesPath gameUserFk3() {
        if (_gameUserFk3 == null)
            _gameUserFk3 = new GamesPath(this, null, Keys.GAMES__GAME_USER_FK3.getInverseKey());
